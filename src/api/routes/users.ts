...
import { handleCreateAccount, handleGetAccounts, handleGetUserById } from '~api/controllers/accounts';
...
export default function generateUsersRoutes(app: Router): void {
  ...
  route.get('/:userId', [validateSchema(userAccountSchema), checkJwt], asyncHandler(handleGetUserById));
}
